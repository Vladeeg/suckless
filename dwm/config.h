...
static const char *fonts[]          = { "Noto Mono:size=10", "FontAwesome:size=10" };
...
static const char *logoutprompt[]  = { "dmenu-logout", NULL };
...
static Key keys[] = {
	...
	TAGKEYS(                        XK_8,                      7)
	TAGKEYS(                        XK_9,                      8)
	{ MODKEY|ShiftMask,             XK_q,      spawn,          {.v = logoutprompt} },
